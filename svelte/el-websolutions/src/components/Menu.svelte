<script>
    ...
    let activeSection = ''; // Reactive variable to track the active section
    let isClickScrolling = false; // New variable to track if the scroll is initiated by clicking
